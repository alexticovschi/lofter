        ...
        <div className="project">
          ...
          <div className="project__description">
            <p>
              ...
              experience to deliver a comprehensive interior/environment to
              bring your vision to reality. We can work in
              partnerships/collaboration with your own architects and designers
              or assist in creating an innovative concept for you.
            </p>
          </div>
        ...
        <div className="project">
          ...
          <div className="project__description">
            <p>
              ...
              your property. Our experienced team will envision the lifestyle
              you wish to depict through furniture, accessories, prints and
              mirrors. Allowing prospective buyers to see each properties full
              potential.
            </p>
          </div>
          <button className="btn project__btn">Get in Touch</button>
        ...
        <div className="project">
          ...
          <div className="project__description">
            <p>
              ...
              inviting home that reflects the purchase needs. We offer a
              tailored design to fit your requirements, budgets and location to
              ensure we maximise the selling potential for your homes.
            </p>
          </div>
          <button className="btn project__btn">Get in Touch</button>
        </div>
